...
def main() -> int:
    ...
    parser.add_argument("--source-id", default="RFB_IRRF_TABLE_2026")
    ...
    if args.source_id not in PARSERS:
        raise SystemExit(f"no Phase 4 parser registered for source_id: {args.source_id}")
